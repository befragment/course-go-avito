...
import (
	...
	order "courier-service/internal/usecase/order"
	reflect "reflect"
	time "time"
...
func (m *MockdeliveryCalculatorFactory) GetDeliveryCalculator(courierType model.CourierTransportType) order.DeliveryCalculator {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDeliveryCalculator", courierType)
	ret0, _ := ret[0].(order.DeliveryCalculator)
	return ret0
}
